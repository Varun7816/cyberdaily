...
const HackerNewsClone = () => {
  ...
  useEffect(() => {
    const sampleStories = [
      {
        id: 1,
        title: "GPT-4 Architecture Insights: How Large Language Models Really Work",
        url: "https://example.com/gpt4-insights",
        author: "deeplearner",
        score: 342,
        comments: [],
        commentCount: 87,
      ...
      {
        id: 2,
        title: "Show HN: I built a real-time collaborative code editor in 48 hours",
      ...
      },
      {
        ...
        type: "ask",
        text: "I've been working as a software engineer for 2 years but want to dive deeper into distributed systems. What resources would you recommend?"
      },
      {
        id: 4,
        title: "The Hidden Costs of Technical Debt in Startup Engineering",
        url: "https://example.com/tech-debt",
        author: "startup_cto",
        score: 189,
        comments: [],
        commentCount: 43,
      ...
      {
        id: 5,
        title: "Tell HN: Just raised $2M seed round for our dev tools startup",
        url: "",
        author: "founder_life",
        score: 234,
        comments: [],
        ...
        type: "tell",
        text: "After 18 months of bootstrapping, we finally closed our seed round. Happy to answer questions about the fundraising process."
      }
    ];

    const sampleUsers = new Map([
      ['deeplearner', { username: 'deeplearner', karma: 2341, created: new Date('2021-03-15') }],
      ['builderbot', { username: 'builderbot', karma: 1876, created: new Date('2020-08-22') }],
      ['newbie_dev', { username: 'newbie_dev', karma: 456, created: new Date('2023-01-10') }],
      ['startup_cto', { username: 'startup_cto', karma: 3245, created: new Date('2019-11-03') }],
      ['founder_life', { username: 'founder_life', karma: 987, created: new Date('2022-06-18') }]
    ]);
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 bg-white text-orange-500 font-bold text-sm flex items-center justify-center">
                Y
              </div>
            ...
            <nav className="hidden md:flex space-x-4 text-sm">
              <button 
                onClick={() => {setView('top'); setSortBy('score');}}
                className={`hover:underline ${view === 'top' ? 'underline' : ''}`}
              >
                top
              </button>
              <button 
                onClick={() => {setView('new'); setSortBy('time');}}
                className={`hover:underline ${view === 'new' ? 'underline' : ''}`}
              >
                new
              </button>
              <button 
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1 text-sm border rounded text-gray-800 w-48"
              />
            </div>
      ...
      <div className="max-w-6xl mx-auto p-4">
        ...
        <div className="mb-4 flex items-center space-x-4 text-sm">
          ...
          <button
            ...
            className={`px-2 py-1 rounded ${sortBy === 'score' ? 'bg-orange-100 text-orange-700' : 'hover:bg-gray-100'}`}
          >
            Score
          </button>
          <button
            onClick={() => setSortBy('time')}
            className={`px-2 py-1 rounded ${sortBy === 'time' ? 'bg-orange-100 text-orange-700' : 'hover:bg-gray-100'}`}
          >
            Time
          </button>
          <button
            onClick={() => setSortBy('comments')}
            className={`px-2 py-1 rounded ${sortBy === 'comments' ? 'bg-orange-100 text-orange-700' : 'hover:bg-gray-100'}`}
          >
            Comments
          </button>
        </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="text-lg font-medium text-gray-900 mb-1">
                        <span className="text-orange-600 font-normal text-sm mr-1">
                          {index + 1}.
                        </span>
...
const SubmitModal = ({ onClose, onSubmit, currentUser }) => {
